...
<head>
    ...
    <title>Edit Sertifikat - ARQI</title>
    ...
    <style>
        ...
        body::before {
            ...
            /* Sedikit transparansi agar tulisan form tetap nyaman dibaca */
            opacity: 0.6; 
...
<body>
    <div class="container" style="max-width: 690px; margin: 0 auto; padding-top: 3rem; padding-bottom: 3rem;">
        ...
        <div class="mb-4 sketch-header text-center">
            ...
            <p class="text-muted fw-bold small mb-0">Edit Sertifikat: {{ $certificate->certificate_number }}</p>
        </div>
                ...
                <form action="{{ route('admin.certificates.update', $certificate->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="ring_number" class="form-control" value="{{ $certificate->ring_number }}" required>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label small">Tanggal Menetas</label>
                            <input type="date" name="hatch_date" class="form-control" value="{{ $certificate->hatch_date }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="bird_type" class="form-control" value="{{ $certificate->bird_type }}" required>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label small">Jenis Kelamin</label>
                            <select name="gender" class="form-select" required>
                                <option value="JANTAN" {{ $certificate->gender == 'JANTAN' ? 'selected' : '' }}>JANTAN</option>
                                <option value="BETINA" {{ $certificate->gender == 'BETINA' ? 'selected' : '' }}>BETINA</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="ring_color" class="form-control" value="{{ $certificate->ring_color }}" required>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="father_breeder" class="form-control" value="{{ $certificate->father_breeder }}" required>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label small">Indukan Betina (Mother)</label>
                            <input type="text" name="mother_breeder" class="form-control" value="{{ $certificate->mother_breeder }}" required>
                        </div>
                    </div>

                    <div class="mb-3">
                        <label class="form-label small"><i class="fa-regular fa-image me-1"></i> Ganti Foto Burung (Kosongkan jika tidak diubah)</label>
                        <input type="file" name="photo" class="form-control" accept="image/*">
                    </div>

                    <div class="mb-4">
                        <label class="form-label small"><i class="fa-regular fa-file-video me-1"></i> Ganti Video Rekaman (Kosongkan jika tidak diubah)</label>
